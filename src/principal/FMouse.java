 ...
 * @author aluno
 */
public class FMouse extends javax.swing.JFrame {

    ctrlMouse ctrlM = new ctrlMouse();
    Mouse m = new Mouse();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        m.setDescricao(edtDescricao.getText());
        m.setProcedencia(edtProcedencia.getText());
        int resp=JOptionPane.showConfirmDialog(null,"Deseja realmente alterar os dados do mouse "+m.getCodigo()+" ?");
        if(resp==JOptionPane.YES_OPTION){
            int erro=ctrlM.alterarMouse(m);
            if(erro==0){
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int rc=m.verificar(cod, "mouse");
        if (rc!=0){
        m.setCodigo(cod);
        int resp=JOptionPane.showConfirmDialog(null,"Deseja resalmente exlcuir o mouse "+m.getCodigo()+" ?");
        if (resp==JOptionPane.YES_OPTION){
            int erro=ctrlM.excluirMouse(m);
            if(erro==0){
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if (rc!=0)
        JOptionPane.showMessageDialog(null,"Mouse de código "+cod+" não encontrada !");
        else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FMouse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
