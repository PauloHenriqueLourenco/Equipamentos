 ...
 * @author P4ul0
 */
public class FSala extends javax.swing.JFrame {

    ctrlSala ctrlS = new ctrlSala();
    Sala s = new Sala();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        s.setCodigo(Integer.parseInt(edtCodigo.getText()));
        s.setNome(edtNome.getText());
        int resp=JOptionPane.showConfirmDialog(null,"Deseja realmente alterar os dados da sala "+s.getNome()+" ?");
        if(resp==JOptionPane.YES_OPTION){
            int erro=ctrlS.alterarSala(s);
            if(erro==0){
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (rc!=0){
        s.setCodigo(cod);
        int resp=JOptionPane.showConfirmDialog(null,"Deseja resalmente exlcuir a sala "+s.getNome()+" ?");
        if (resp==JOptionPane.YES_OPTION){
            int erro=ctrlS.excluirSala(s);
            if(erro==0){
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if (rc!=0)
        JOptionPane.showMessageDialog(null,"Sala de código "+cod+" não encontrada !");
        else {
            edtNome.setText(s.getNome());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FSala.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
