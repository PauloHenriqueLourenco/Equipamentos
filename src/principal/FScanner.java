 ...
 * @author aluno
 */
public class FScanner extends javax.swing.JFrame {

    ctrlScanner ctrlS = new ctrlScanner();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        FScanner.this.dispose();
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        s.setNum_componente(Integer.parseInt(edtNumComp.getText()));
        s.setNum_serie(Integer.parseInt(edtNumSerie.getText()));
        s.setCodigo(Integer.parseInt(edtCodigo.getText()));
        s.setFabricante(edtFabricante.getText());
        s.setModelo(edtModelo.getText());
        s.setDescricao(edtDescricao.getText());
        s.setProcedencia(edtProcedencia.getText());
        int erro=ctrlS.inserirScanner(s);
        if(erro==0){
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        s.setDescricao(edtDescricao.getText());
        s.setProcedencia(edtProcedencia.getText());
        int resp=JOptionPane.showConfirmDialog(null,"Deseja realmente alterar os dados do scanner "+s.getCodigo()+" ?");
        if(resp==JOptionPane.YES_OPTION){
            int erro=ctrlS.alterarScanner(s);
            if(erro==0){
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int rc=s.verificar(cod, "scanner");
        if (rc!=0){
        s.setCodigo(cod);
        int resp=JOptionPane.showConfirmDialog(null,"Deseja resalmente exlcuir o scanner "+s.getCodigo()+" ?");
        if (resp==JOptionPane.YES_OPTION){
            int erro=ctrlS.excluirScanner(s);
            if(erro==0){
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if (rc!=0)
        JOptionPane.showMessageDialog(null,"Scanner de código "+cod+" não encontrada !");
        else {
            edtNumComp.setText(String.valueOf(s.getNum_componente()));
            edtNumSerie.setText(String.valueOf(s.getNum_serie()));
            edtFabricante.setText(s.getFabricante());
            edtDescricao.setText(s.getDescricao());
            edtModelo.setText(s.getModelo());
            edtProcedencia.setText(s.getProcedencia());
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        edtNumComp.setText(String.valueOf(s.calcNumComp()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FScanner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
