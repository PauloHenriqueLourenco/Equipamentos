...
import DAO.ctrlImpressora;
import javax.swing.JOptionPane;
import modelo.*;



public class FImpressora extends javax.swing.JFrame {
    ctrlImpressora ctrlI = new ctrlImpressora();
    ...
    public void resetar() {
        ...
        edtVelocidade.setEnabled(false);
    ...
    private void initComponents() {
        ...
        edtVelocidade = new javax.swing.JTextField();
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(edtVelocidade, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(edtVelocidade, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblVelocidade)
                    .addComponent(jLabel6)
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int rc=i.verificar(cod, "impressora");
        if (rc!=0){
        i.setCodigo(cod);
           int resp=JOptionPane.showConfirmDialog(null,"Deseja resalmente exlcuir a impressora "+i.getCodigo()+" ?");
           if (resp==JOptionPane.YES_OPTION){
               int erro=ctrlI.excluirImpressora(i);
               if(erro==0){
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        i.setNum_componente(Integer.parseInt(edtNumComp.getText()));
        i.setNum_serie(Integer.parseInt(edtNumSerie.getText()));
        i.setCodigo(Integer.parseInt(edtCodigo.getText()));
        i.setFabricante(edtFabricante.getText());
        i.setModelo(edtModelo.getText());
        i.setDescricao(edtDescricao.getText());
        i.setVelocidade(Integer.parseInt(edtVelocidade.getText()));
        i.setProcedencia(edtProcedencia.getText());
        int erro=ctrlI.inserirImpressora(i);
            if(erro==0){
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        i.setVelocidade(Integer.parseInt(edtVelocidade.getText()));
        i.setProcedencia(edtProcedencia.getText());
        int resp=JOptionPane.showConfirmDialog(null,"Deseja realmente alterar os dados da impressora "+i.getCodigo()+" ?");
        if(resp==JOptionPane.YES_OPTION){
        int erro=ctrlI.alterarImpressora(i);
            if(erro==0){
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        int cod=Integer.parseInt(edtCodigo.getText());
        int rc=ctrlI.consultar(cod, i);
        if (rc!=0)
             JOptionPane.showMessageDialog(null,"Impressora de código "+cod+" não encontrada !");
        else {
           edtNumComp.setText(String.valueOf(i.getNum_componente()));
           edtNumSerie.setText(String.valueOf(i.getNum_serie()));
           edtFabricante.setText(i.getFabricante());
           edtDescricao.setText(i.getDescricao());
           edtModelo.setText(i.getModelo());
           edtProcedencia.setText(i.getProcedencia());
           edtCodigo.setText(String.valueOf(i.getCodigo()));
           edtVelocidade.setText(String.valueOf(i.getVelocidade()));
           liberar();
           edtNumComp.setEnabled(false);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        edtNumComp.setText(String.valueOf(i.calcNumComp()));
        edtCodigo.setText(String.valueOf(ctrlI.calcChave()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FImpressora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField edtVelocidade;
