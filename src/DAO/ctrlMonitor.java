 ...
 * @author P4ul0
 */
public class ctrlMonitor {
    
    public int calcChave(){
        int cod=9999;
        String sql = "SELECT codigo FROM monitor ORDER BY codigo DESC LIMIT 1";
    ...
    public int inserirMonitor (Monitor m){
       int rc=0;
       String sqli = "INSERT INTO monitor VALUES("+m.getNum_componente()+","+m.getCodigo()+","+m.getPolegadas()+")";
   ...
   public int alterarMonitor(Monitor m){
      int rc=0;
       ...
       String sqli = "UPDATE monitor SET polegadas="+m.getPolegadas()+" WHERE codigo="+m.getCodigo();
       Connection cn = Conexao.getConnection();
       System.out.println(sqlc);
       System.out.println(sqli);
       try{
   ...
   public int excluirMonitor(Monitor m){
       int rc=0;
       String sqli = "DELETE FROM monitor WHERE codigo="+m.getCodigo();
   ...
   public int consultar(int cod, Monitor m){
      int rc=111;
       String sqli = "SELECT * FROM monitor WHERE codigo="+cod;
       Connection cn = Conexao.getConnection();
       System.out.println(sqli);
       try{
           Statement st = cn.createStatement();
